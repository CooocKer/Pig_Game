...
const curent0Element = document.getElementById('current--0');
const curent1Element = document.getElementById('current--1');
...
const initGame = function () {
  ...
  curent0Element.textContent = 0;
  curent1Element.textContent = 0;
...
btnHold.addEventListener('click', function () {
  if (isPlaying) {
    //1. Current score to active player total score
